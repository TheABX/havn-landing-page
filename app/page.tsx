...
export default function HAVNLandingPage() {
  return (
    <main className="min-h-screen bg-[#05070A] text-slate-100" style={{ color: '#e2e8f0' }}>
      {/* HERO SECTION */}
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative z-20">
              {/* Eyebrow/Badge */}
              <div className="inline-flex items-center rounded-full border border-slate-700 px-3 py-1 text-xs tracking-[0.18em] uppercase text-slate-300 mb-4" style={{ color: '#cbd5e1' }}>
                ALL-NATURAL SOLID COLOGNE
              </div>

              {/* Main Headline */}
              <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-slate-50 mb-4" style={{ color: '#f8fafc' }}>
                Smell like a man. Not a chemical factory.
              </h1>

              {/* Subheadline */}
              <p className="text-sm md:text-base text-slate-300 mb-6 max-w-xl" style={{ color: '#cbd5e1' }}>
              ...
              {/* Benefit Bullets */}
              <ul className="space-y-2 text-sm md:text-base text-slate-300" style={{ color: '#cbd5e1' }}>
            ...
            {/* Right: Product Image */}
            <div className="relative h-80 md:h-[460px] rounded-2xl border border-slate-800 shadow-2xl shadow-black/40 overflow-hidden bg-slate-900/50 z-10">
              <Image
      ...
      {/* KEY VALUE PROPOSITION / WHY HAVN SECTION */}
      <section id="why-natural" className="border-t border-slate-800 bg-[#05070A] relative z-10">
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
          <div className="grid gap-12 md:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)] items-start">
            {/* Left Column: Text Content */}
            <div className="relative z-20">
              {/* Section Eyebrow */}
              <div className="text-xs tracking-[0.18em] uppercase text-amber-400 mb-3" style={{ color: '#fbbf24' }}>
                WHY HAVN
              </div>

              {/* Heading */}
              <h2 className="text-2xl md:text-3xl font-semibold text-slate-50 tracking-tight mb-4" style={{ color: '#f8fafc' }}>
                A clean cologne for men who actually care what goes on their skin.
              </h2>

              {/* Body Copy */}
              <p className="text-sm md:text-base text-slate-300 mb-8 max-w-xl" style={{ color: '#cbd5e1' }}>
                Most colognes are loaded with synthetic fragrance chemicals, drying alcohols, and potential endocrine disruptors you spray directly onto your neck and wrists every day. HAVN is different. It's a solid cologne made with natural ingredients that smell rugged and real, without the chemical cloud.
              </p>

              {/* Benefit Grid */}
              <div className="grid gap-6 sm:grid-cols-2">
                {/* Card 1: Natural */}
                <div className="rounded-2xl border border-slate-800 bg-slate-900/40 px-4 py-5">
                  <p className="text-[11px] font-semibold tracking-[0.16em] uppercase text-amber-400 mb-1" style={{ color: '#fbbf24' }}>
                    Natural
                  </p>
                  <h3 className="text-sm md:text-base font-semibold text-slate-50 mb-1" style={{ color: '#f8fafc' }}>
                    No endocrine-disrupting chemicals
                  </h3>
                  <p className="text-xs md:text-sm text-slate-300" style={{ color: '#cbd5e1' }}>
                    Crafted with natural ingredients instead of mystery synthetics, so you're not spraying questionable chemicals onto your skin and into your bloodstream every day.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-900/40 px-4 py-5">
                  ...
                  <h3 className="text-sm md:text-base font-semibold text-slate-50 mb-1" style={{ color: '#f8fafc' }}>
                    Smells like the outdoors, not the mall
                  </h3>
                  <p className="text-xs md:text-sm text-slate-300" style={{ color: '#cbd5e1' }}>
                    Warm sandalwood, cedar, amber, and vetiver come together in a grounded scent profile that feels masculine without shouting.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-900/40 px-4 py-5">
                  ...
                  <h3 className="text-sm md:text-base font-semibold text-slate-50 mb-1" style={{ color: '#f8fafc' }}>
                    Pocket-sized for real life
                  </h3>
                  <p className="text-xs md:text-sm text-slate-300" style={{ color: '#cbd5e1' }}>
                    The solid tin slips into your jeans, gym bag, or carry-on. No glass bottle, no leaks, no "can I take this through security?" drama.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-800 bg-slate-900/40 px-4 py-5">
                  ...
                  <h3 className="text-sm md:text-base font-semibold text-slate-50 mb-1" style={{ color: '#f8fafc' }}>
                    Dial the strength up or down
                  </h3>
                  <p className="text-xs md:text-sm text-slate-300" style={{ color: '#cbd5e1' }}>
                    Swipe a little for everyday, or build it up before a night out. You control how strong it is instead of being hit with an instant chemical blast.
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Right Column: Image */}
            <div className="relative h-64 sm:h-80 md:h-[360px] lg:h-[420px] z-10">
              <Image
                src="/havn/havn-tin-on-wood-1.jpg"
                alt="HAVN solid cologne tin on natural wood surface"
                fill
                className="object-cover rounded-2xl border border-slate-800 shadow-2xl shadow-black/40"
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20">
          <div className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] items-start">
            ...
            <div className="relative h-64 sm:h-80 md:h-[360px] lg:h-[420px]">
              <Image
                src="/havn/havn-hero-tin-wood-vertical.jpg.png"
